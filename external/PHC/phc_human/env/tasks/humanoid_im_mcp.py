import time
import torch
import phc_human.env.tasks.humanoid_im as humanoid_im

from isaacgym.torch_utils import *
from phc_human.utils.flags import flags
from rl_games.algos_torch import torch_ext
import torch.nn as nn
from phc_human.learning.pnn import PNN
...
class HumanoidImMCP(humanoid_im.HumanoidIm):
    ...
    def step(self, weights):
        ...
        with torch.no_grad():
            ...
            curr_obs = torch.clamp(curr_obs, min=-5.0, max=5.0) # ([1, 945])
