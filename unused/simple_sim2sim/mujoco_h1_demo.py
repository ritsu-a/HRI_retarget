...
class MujocoSim:
    ...
    def __init__(
        ...
        self.viewer.cam.trackbodyid = self.mj_model.body("torso_link").id
    ...
    def run(self):
        ...
        while True:
            ...
            for _ in range(int(self.viewer_dt / self.simulate_dt)):
                self.low_command_to_torque(low_cmd)
                mujoco.mj_step(self.mj_model, self.mj_data)
            self.viewer.cam.trackbodyid = self.mj_model.body("torso_link").id
            self.viewer.sync()
            # self.viewer.cam.render()
...
if __name__ == "__main__":
    ...
    policy = TrackPolicy(
        ...
        # '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/demo/box.onnx',
        # '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/1106_h2o_box_dr/policy_30000.onnx',
        # '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/1107_walkhandup/policy_90000.onnx',
        ...
        '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/demo/walk.onnx',

        # '/home/ubuntu/data/MDM/dn_20hand.pkl', # 3 7 33
        # '/home/ubuntu/data/MDM/rcp_35hand.pkl'
        # '/home/ubuntu/data/MDM/rcp_35_mdm.pkl', # 3 7 33
        # '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/demo/15walk.pkl',
        # '/home/ubuntu/data/MDM/dn_15_walk_mdm.pkl', # 0
        # '/home/ubuntu/data/MDM/rcp_10box_mdm.pkl'  # 2 5 6 7 8 9
        # '/home/ubuntu/data/MDM/pop_10_swingwalk.pkl' # 1 3 7.
        '/home/ubuntu/workspace/H1_RL/HST/legged_gym/logs/h1-s2r/demo/15walk.pkl'
    )
