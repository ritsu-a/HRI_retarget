...
def body_mean_variance(data_dir, save_dir):
    ...
    Std[:81] = Std[:81].mean() / 1.0
    Std[81:162] = Std[81:162].mean() / 1.0
    Std[162:] = Std[162:].mean() / 1.0

    assert Std.shape[-1] == 179
...
if __name__ == '__main__':
    data_dir = '/root/pengyang/codebase/HRI_MLLM/data/BEAT_v1_kimi/new_joint_vecs'
    save_dir = '/root/pengyang/codebase/HRI_MLLM/data/BEAT_v1_kimi'
