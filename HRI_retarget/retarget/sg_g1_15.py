...
from HRI_retarget.utils.vis.bvh_vis import Get_bvh_joint_local_coord_parallel
...
from HRI_retarget.config.joint_mapping import SG_LINKS, SG_G1_CORRESPONDENCE
...
if __name__ == "__main__":
    ...
    bvh_joint_local_coord = Get_bvh_joint_local_coord_parallel(filename, link_list=SG_LINKS)
