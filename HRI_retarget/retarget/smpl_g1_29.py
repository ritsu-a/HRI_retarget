### usage:
### python smpl_g1_29.py {path_to_npy_file}
### python smpl_g1_29.py data/motion/human/HumanML3D/new_joints/000000.npy
...
from HRI_retarget.config.joint_mapping import SMPL_G1_CORRESPONDENCE
...
if __name__ == "__main__":
    ...
    vis_kinematic_result(os.path.join(DATA_ROOT,"motion/g1/SMPL", filename.split("/")[-1][:-4] + ".pickle"), dataset="MDM", robot="g1_29", correspondence=SMPL_G1_CORRESPONDENCE)
