...
from HRI_retarget.config.joint_mapping import SEG_LINKS, SEG_GALBOT_CHARLIE_CORRESPONDENCE
...
if __name__ == "__main__":
    ...
    filename = sys.argv[1]
    bvh_joint_local_coord = Get_bvh_joint_local_coord(filename, link_list=SEG_LINKS)
