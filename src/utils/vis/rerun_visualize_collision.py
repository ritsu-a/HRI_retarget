...
class RerunURDF():
    def __init__(self, robot_type, urdf_path, mesh_dir,srdf_path, Tpose):
        ...
        #     self.robot.model, urdf_path, pin.GeometryType.COLLISION, mesh_dir
        # )
    ...
    def get_link2mesh(self):
        ...
        for visual in self.robot.visual_model.geometryObjects:
            ...
            link2mesh[name] = mesh
            # link2mesh["torso_link"].albedo_factos = [1.0,0.0,0.0,1.0]
        return link2mesh
    ...
    def init_collision_checking(self):
        ...
        # self.link2mesh_origin = deepcopy(self.link2mesh)
        # self.link2mesh_red = deepcopy(self.link2mesh)
        # for key in self.link2mesh_red.keys():
        #     self.link2mesh_red[key].albedo_factor = [1.0,0.0,0.0,1.0]
    ...
    def update_mesh(self,collison_set):
        ...
        #     self.link2mesh[link] = \
        #         self.link2mesh_origin[link]
        # for link in added_collision_links:
        #     self.link2mesh[link] = \
        #         self.link2mesh_red[link]
...
if __name__ == "__main__":
    ...
    for frame_nr in range(data.shape[0]):
        ...
        if(rerun_urdf.update(configuration)):
            print("Collision Frames: ",frame_nr)